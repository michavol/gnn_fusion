...
python src/model_fusion.py graph_cost=feature_lp batch_size=340 optimal_transport=emd experiment_models_dir=/prebn_models/ models_conf_dir=../../../src/conf/models/prebn_models/ fine_tune=False acts_from_bn=False
