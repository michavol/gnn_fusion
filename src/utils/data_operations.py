...
def get_train_test_loaders(args: DictConfig):
    dataset = LoadData(args.dataset_name, custom_data_dir='/home/ehoskovec/Workspace/ETH/master/sem3/deepLearning/Project/gnn_fusion/gnn_benchmarking/data/molecules/')
